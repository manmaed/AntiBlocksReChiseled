...
public class ModBlocksTagsProvider extends BlockTagsProvider {
    ...
    public static final Block[] SLABS = {
            //Slabs
            ABRCSlabs.SLAB_BRIGHT_WHITE.get(),
            ABRCSlabs.SLAB_BRIGHT_BLACK.get(),
            ABRCSlabs.SLAB_BRIGHT_ORANGE.get(),
            ABRCSlabs.SLAB_BRIGHT_MAGENTA.get(),
            ABRCSlabs.SLAB_BRIGHT_YELLOW.get(),
            ABRCSlabs.SLAB_BRIGHT_CYAN.get(),
            ABRCSlabs.SLAB_BRIGHT_BLUE.get(),
            ABRCSlabs.SLAB_BRIGHT_GREEN.get(),
            ABRCSlabs.SLAB_BRIGHT_RED.get(),
            ABRCSlabs.SLAB_WOOL_WHITE.get(),
            ABRCSlabs.SLAB_WOOL_ORANGE.get(),
            ABRCSlabs.SLAB_WOOL_MAGENTA.get(),
            ABRCSlabs.SLAB_WOOL_LIGHT_BLUE.get(),
            ABRCSlabs.SLAB_WOOL_YELLOW.get(),
            ABRCSlabs.SLAB_WOOL_LIME.get(),
            ABRCSlabs.SLAB_WOOL_PINK.get(),
            ABRCSlabs.SLAB_WOOL_GRAY.get(),
            ABRCSlabs.SLAB_WOOL_LIGHT_GRAY.get(),
            ABRCSlabs.SLAB_WOOL_CYAN.get(),
            ABRCSlabs.SLAB_WOOL_PURPLE.get(),
            ABRCSlabs.SLAB_WOOL_BLUE.get(),
            ABRCSlabs.SLAB_WOOL_BROWN.get(),
            ABRCSlabs.SLAB_WOOL_GREEN.get(),
            ABRCSlabs.SLAB_WOOL_RED.get()
};
    public static final Block[] STAIRS = {
            //Stairs
            ABRCStairs.STAIR_BRIGHT_WHITE.get(),
            ABRCStairs.STAIR_BRIGHT_BLACK.get(),
            ABRCStairs.STAIR_BRIGHT_ORANGE.get(),
            ABRCStairs.STAIR_BRIGHT_MAGENTA.get(),
            ABRCStairs.STAIR_BRIGHT_YELLOW.get(),
            ABRCStairs.STAIR_BRIGHT_CYAN.get(),
            ABRCStairs.STAIR_BRIGHT_BLUE.get(),
            ABRCStairs.STAIR_BRIGHT_GREEN.get(),
            ABRCStairs.STAIR_BRIGHT_RED.get(),
            ABRCStairs.STAIR_WOOL_WHITE.get(),
            ABRCStairs.STAIR_WOOL_ORANGE.get(),
            ABRCStairs.STAIR_WOOL_MAGENTA.get(),
            ABRCStairs.STAIR_WOOL_LIGHT_BLUE.get(),
            ABRCStairs.STAIR_WOOL_YELLOW.get(),
            ABRCStairs.STAIR_WOOL_LIME.get(),
            ABRCStairs.STAIR_WOOL_PINK.get(),
            ABRCStairs.STAIR_WOOL_GRAY.get(),
            ABRCStairs.STAIR_WOOL_LIGHT_GRAY.get(),
            ABRCStairs.STAIR_WOOL_CYAN.get(),
            ABRCStairs.STAIR_WOOL_PURPLE.get(),
            ABRCStairs.STAIR_WOOL_BLUE.get(),
            ABRCStairs.STAIR_WOOL_BROWN.get(),
            ABRCStairs.STAIR_WOOL_GREEN.get(),
            ABRCStairs.STAIR_WOOL_RED.get()
};
