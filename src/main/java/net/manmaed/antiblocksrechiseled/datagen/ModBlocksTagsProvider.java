...
public class ModBlocksTagsProvider extends BlockTagsProvider {
    ...
    protected void addTags(HolderLookup.Provider provider) {
        tag(BlockTags.MINEABLE_WITH_PICKAXE).add(BIGHT_BLOCKS).add(WOOL_BLOCKS).add(SLABS).add(STAIRS).add(BUTTONS).add(PRESSURE_PLATES);
        tag(BlockTags.NEEDS_IRON_TOOL).add(BIGHT_BLOCKS).add(WOOL_BLOCKS).add(SLABS).add(STAIRS).add(BUTTONS).add(PRESSURE_PLATES);
