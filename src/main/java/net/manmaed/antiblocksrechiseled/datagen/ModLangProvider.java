...
//SLABS
        add(ABRCSlabs.SLAB_BRIGHT_WHITE.get(), getOther("Slab", "White", "Bright"));
        add(ABRCSlabs.SLAB_BRIGHT_BLACK.get(), getOther("Slab", "Black", "Bright"));
        add(ABRCSlabs.SLAB_BRIGHT_ORANGE.get(), getOther("Slab", "Orange", "Bright"));
        add(ABRCSlabs.SLAB_BRIGHT_MAGENTA.get(), getOther("Slab", "Magenta", "Bright"));
        add(ABRCSlabs.SLAB_BRIGHT_YELLOW.get(), getOther("Slab", "Yellow", "Bright"));
        add(ABRCSlabs.SLAB_BRIGHT_CYAN.get(), getOther("Slab", "Cyan", "Bright"));
        add(ABRCSlabs.SLAB_BRIGHT_BLUE.get(), getOther("Slab", "Blue", "Bright"));
        add(ABRCSlabs.SLAB_BRIGHT_GREEN.get(), getOther("Slab", "Green", "Bright"));
        add(ABRCSlabs.SLAB_BRIGHT_RED.get(), getOther("Slab", "Red", "Bright"));
        add(ABRCSlabs.SLAB_WOOL_WHITE.get(), getOther("Slab", "White", "Wool"));
        add(ABRCSlabs.SLAB_WOOL_ORANGE.get(), getOther("Slab", "Orange", "Wool"));
        add(ABRCSlabs.SLAB_WOOL_MAGENTA.get(), getOther("Slab", "Magenta", "Wool"));
        add(ABRCSlabs.SLAB_WOOL_LIGHT_BLUE.get(), getOther("Slab", "Light Blue", "Wool"));
        add(ABRCSlabs.SLAB_WOOL_YELLOW.get(), getOther("Slab", "Yellow", "Wool"));
        add(ABRCSlabs.SLAB_WOOL_LIME.get(), getOther("Slab", "Lime", "Wool"));
        add(ABRCSlabs.SLAB_WOOL_PINK.get(), getOther("Slab", "Pink", "Wool"));
        add(ABRCSlabs.SLAB_WOOL_GRAY.get(), getOther("Slab", "Gray", "Wool"));
        add(ABRCSlabs.SLAB_WOOL_LIGHT_GRAY.get(), getOther("Slab", "Light Gray", "Wool"));
        add(ABRCSlabs.SLAB_WOOL_CYAN.get(), getOther("Slab", "Cyan", "Wool"));
        add(ABRCSlabs.SLAB_WOOL_PURPLE.get(), getOther("Slab", "Purple", "Wool"));
        add(ABRCSlabs.SLAB_WOOL_BLUE.get(), getOther("Slab", "Blue", "Wool"));
        add(ABRCSlabs.SLAB_WOOL_BROWN.get(), getOther("Slab", "Brown", "Wool"));
        add(ABRCSlabs.SLAB_WOOL_GREEN.get(), getOther("Slab", "Green", "Wool"));
        add(ABRCSlabs.SLAB_WOOL_RED.get(), getOther("Slab", "Red", "Wool"));

        add(ABRCSlabs.SLAB_BRIGHT_WHITE_ITEM.get(), getOther("Slab", "White", "Bright"));
        add(ABRCSlabs.SLAB_BRIGHT_BLACK_ITEM.get(), getOther("Slab", "Black", "Bright"));
        add(ABRCSlabs.SLAB_BRIGHT_ORANGE_ITEM.get(), getOther("Slab", "Orange", "Bright"));
        add(ABRCSlabs.SLAB_BRIGHT_MAGENTA_ITEM.get(), getOther("Slab", "Magenta", "Bright"));
        add(ABRCSlabs.SLAB_BRIGHT_YELLOW_ITEM.get(), getOther("Slab", "Yellow", "Bright"));
        add(ABRCSlabs.SLAB_BRIGHT_CYAN_ITEM.get(), getOther("Slab", "Cyan", "Bright"));
        add(ABRCSlabs.SLAB_BRIGHT_BLUE_ITEM.get(), getOther("Slab", "Blue", "Bright"));
        add(ABRCSlabs.SLAB_BRIGHT_GREEN_ITEM.get(), getOther("Slab", "Green", "Bright"));
        add(ABRCSlabs.SLAB_BRIGHT_RED_ITEM.get(), getOther("Slab", "Red", "Bright"));
        add(ABRCSlabs.SLAB_WOOL_WHITE_ITEM.get(), getOther("Slab", "White", "Wool"));
        add(ABRCSlabs.SLAB_WOOL_ORANGE_ITEM.get(), getOther("Slab", "Orange", "Wool"));
        add(ABRCSlabs.SLAB_WOOL_MAGENTA_ITEM.get(), getOther("Slab", "Magenta", "Wool"));
        add(ABRCSlabs.SLAB_WOOL_LIGHT_BLUE_ITEM.get(), getOther("Slab", "Light Blue", "Wool"));
        add(ABRCSlabs.SLAB_WOOL_YELLOW_ITEM.get(), getOther("Slab", "Yellow", "Wool"));
        add(ABRCSlabs.SLAB_WOOL_LIME_ITEM.get(), getOther("Slab", "Lime", "Wool"));
        add(ABRCSlabs.SLAB_WOOL_PINK_ITEM.get(), getOther("Slab", "Pink", "Wool"));
        add(ABRCSlabs.SLAB_WOOL_GRAY_ITEM.get(), getOther("Slab", "Gray", "Wool"));
        add(ABRCSlabs.SLAB_WOOL_LIGHT_GRAY_ITEM.get(), getOther("Slab", "Light Gray", "Wool"));
        add(ABRCSlabs.SLAB_WOOL_CYAN_ITEM.get(), getOther("Slab", "Cyan", "Wool"));
        add(ABRCSlabs.SLAB_WOOL_PURPLE_ITEM.get(), getOther("Slab", "Purple", "Wool"));
        add(ABRCSlabs.SLAB_WOOL_BLUE_ITEM.get(), getOther("Slab", "Blue", "Wool"));
        add(ABRCSlabs.SLAB_WOOL_BROWN_ITEM.get(), getOther("Slab", "Brown", "Wool"));
        add(ABRCSlabs.SLAB_WOOL_GREEN_ITEM.get(), getOther("Slab", "Green", "Wool"));
        add(ABRCSlabs.SLAB_WOOL_RED_ITEM.get(), getOther("Slab", "Red", "Wool"));

//Starirs
        add(ABRCStairs.STAIR_BRIGHT_WHITE.get(), getOther("Stair", "White", "Bright"));
        add(ABRCStairs.STAIR_BRIGHT_BLACK.get(), getOther("Stair", "Black", "Bright"));
        add(ABRCStairs.STAIR_BRIGHT_ORANGE.get(), getOther("Stair", "Orange", "Bright"));
        add(ABRCStairs.STAIR_BRIGHT_MAGENTA.get(), getOther("Stair", "Magenta", "Bright"));
        add(ABRCStairs.STAIR_BRIGHT_YELLOW.get(), getOther("Stair", "Yellow", "Bright"));
        add(ABRCStairs.STAIR_BRIGHT_CYAN.get(), getOther("Stair", "Cyan", "Bright"));
        add(ABRCStairs.STAIR_BRIGHT_BLUE.get(), getOther("Stair", "Blue", "Bright"));
        add(ABRCStairs.STAIR_BRIGHT_GREEN.get(), getOther("Stair", "Green", "Bright"));
        add(ABRCStairs.STAIR_BRIGHT_RED.get(), getOther("Stair", "Red", "Bright"));
        add(ABRCStairs.STAIR_WOOL_WHITE.get(), getOther("Stair", "White", "Wool"));
        add(ABRCStairs.STAIR_WOOL_ORANGE.get(), getOther("Stair", "Orange", "Wool"));
        add(ABRCStairs.STAIR_WOOL_MAGENTA.get(), getOther("Stair", "Magenta", "Wool"));
        add(ABRCStairs.STAIR_WOOL_LIGHT_BLUE.get(), getOther("Stair", "Light Blue", "Wool"));
        add(ABRCStairs.STAIR_WOOL_YELLOW.get(), getOther("Stair", "Yellow", "Wool"));
        add(ABRCStairs.STAIR_WOOL_LIME.get(), getOther("Stair", "Lime", "Wool"));
        add(ABRCStairs.STAIR_WOOL_PINK.get(), getOther("Stair", "Pink", "Wool"));
        add(ABRCStairs.STAIR_WOOL_GRAY.get(), getOther("Stair", "Gray", "Wool"));
        add(ABRCStairs.STAIR_WOOL_LIGHT_GRAY.get(), getOther("Stair", "Light Gray", "Wool"));
        add(ABRCStairs.STAIR_WOOL_CYAN.get(), getOther("Stair", "Cyan", "Wool"));
        add(ABRCStairs.STAIR_WOOL_PURPLE.get(), getOther("Stair", "Purple", "Wool"));
        add(ABRCStairs.STAIR_WOOL_BLUE.get(), getOther("Stair", "Blue", "Wool"));
        add(ABRCStairs.STAIR_WOOL_BROWN.get(), getOther("Stair", "Brown", "Wool"));
        add(ABRCStairs.STAIR_WOOL_GREEN.get(), getOther("Stair", "Green", "Wool"));
        add(ABRCStairs.STAIR_WOOL_RED.get(), getOther("Stair", "Red", "Wool"));

        add(ABRCStairs.STAIR_BRIGHT_WHITE_ITEM.get(), getOther("Stair", "White", "Bright"));
        add(ABRCStairs.STAIR_BRIGHT_BLACK_ITEM.get(), getOther("Stair", "Black", "Bright"));
        add(ABRCStairs.STAIR_BRIGHT_ORANGE_ITEM.get(), getOther("Stair", "Orange", "Bright"));
        add(ABRCStairs.STAIR_BRIGHT_MAGENTA_ITEM.get(), getOther("Stair", "Magenta", "Bright"));
        add(ABRCStairs.STAIR_BRIGHT_YELLOW_ITEM.get(), getOther("Stair", "Yellow", "Bright"));
        add(ABRCStairs.STAIR_BRIGHT_CYAN_ITEM.get(), getOther("Stair", "Cyan", "Bright"));
        add(ABRCStairs.STAIR_BRIGHT_BLUE_ITEM.get(), getOther("Stair", "Blue", "Bright"));
        add(ABRCStairs.STAIR_BRIGHT_GREEN_ITEM.get(), getOther("Stair", "Green", "Bright"));
        add(ABRCStairs.STAIR_BRIGHT_RED_ITEM.get(), getOther("Stair", "Red", "Bright"));
        add(ABRCStairs.STAIR_WOOL_WHITE_ITEM.get(), getOther("Stair", "White", "Wool"));
        add(ABRCStairs.STAIR_WOOL_ORANGE_ITEM.get(), getOther("Stair", "Orange", "Wool"));
        add(ABRCStairs.STAIR_WOOL_MAGENTA_ITEM.get(), getOther("Stair", "Magenta", "Wool"));
        add(ABRCStairs.STAIR_WOOL_LIGHT_BLUE_ITEM.get(), getOther("Stair", "Light Blue", "Wool"));
        add(ABRCStairs.STAIR_WOOL_YELLOW_ITEM.get(), getOther("Stair", "Yellow", "Wool"));
        add(ABRCStairs.STAIR_WOOL_LIME_ITEM.get(), getOther("Stair", "Lime", "Wool"));
        add(ABRCStairs.STAIR_WOOL_PINK_ITEM.get(), getOther("Stair", "Pink", "Wool"));
        add(ABRCStairs.STAIR_WOOL_GRAY_ITEM.get(), getOther("Stair", "Gray", "Wool"));
        add(ABRCStairs.STAIR_WOOL_LIGHT_GRAY_ITEM.get(), getOther("Stair", "Light Gray", "Wool"));
        add(ABRCStairs.STAIR_WOOL_CYAN_ITEM.get(), getOther("Stair", "Cyan", "Wool"));
        add(ABRCStairs.STAIR_WOOL_PURPLE_ITEM.get(), getOther("Stair", "Purple", "Wool"));
        add(ABRCStairs.STAIR_WOOL_BLUE_ITEM.get(), getOther("Stair", "Blue", "Wool"));
        add(ABRCStairs.STAIR_WOOL_BROWN_ITEM.get(), getOther("Stair", "Brown", "Wool"));
        add(ABRCStairs.STAIR_WOOL_GREEN_ITEM.get(), getOther("Stair", "Green", "Wool"));
        add(ABRCStairs.STAIR_WOOL_RED_ITEM.get(), getOther("Stair", "Red", "Wool"));
