...
public class ABRCenud extends LanguageProvider {
    ...
    protected void addTranslations() {
        ...
        //SLABS
        add(ABRCSlabs.SLAB_BRIGHT_WHITE.get(), "qɐ⅃s ʞɔןoqʇ∀ ᴉʇɥM ʇɥƃᴉɹꞁ");
        add(ABRCSlabs.SLAB_BRIGHT_BLACK.get(), "qɐ⅃s ʞɔןoqʇ∀ ʞɔɐןq ʇɥƃᴉɹꞁ");
        add(ABRCSlabs.SLAB_BRIGHT_ORANGE.get(), "qɐ⅃s ʞɔןoqʇ∀ ǝƃuɐɹO ʇɥƃᴉɹꞁ");
        add(ABRCSlabs.SLAB_BRIGHT_MAGENTA.get(), "qɐ⅃s ʞɔןoqʇ∀ ɐʇuǝƃɐW ʇɥƃᴉɹꞁ");
        add(ABRCSlabs.SLAB_BRIGHT_YELLOW.get(), "qɐ⅃s ʞɔןoqʇ∀ ʍollǝ⅄ ʇɥƃᴉɹꞁ");
        add(ABRCSlabs.SLAB_BRIGHT_CYAN.get(), "qɐ⅃s ʞɔןoqʇ∀ uɐ⅄ɔ ʇɥƃᴉɹꞁ");
        add(ABRCSlabs.SLAB_BRIGHT_BLUE.get(), "qɐ⅃s ʞɔןoqʇ∀ ǝǝןq ʇɥƃᴉɹꞁ");
        add(ABRCSlabs.SLAB_BRIGHT_GREEN.get(), "qɐ⅃s ʞɔןoqʇ∀ uǝǝɹƃ ʇɥƃᴉɹꞁ");
        add(ABRCSlabs.SLAB_BRIGHT_RED.get(), "qɐ⅃s ʞɔןoqʇ∀ pǝɹ ʇɥƃᴉɹꞁ");

        add(ABRCSlabs.SLAB_WOOL_WHITE.get(), "qɐ⅃s ʞɔןoqʇ∀ ǝʃlooʍ ǝᴉʇɥM");
        add(ABRCSlabs.SLAB_WOOL_ORANGE.get(), "qɐ⅃s ʞɔןoqʇ∀ ǝʃlooʍ ǝƃuɐɹO");
        add(ABRCSlabs.SLAB_WOOL_MAGENTA.get(), "qɐ⅃s ʞɔןoqʇ∀ ǝʃlooʍ ɐʇuǝƃɐW");
        add(ABRCSlabs.SLAB_WOOL_LIGHT_BLUE.get(), "qɐ⅃s ʞɔןoqʇ∀ ǝʃlooʍ ǝǝןq ʇɥƃᴉ⅃");
        add(ABRCSlabs.SLAB_WOOL_YELLOW.get(), "qɐ⅃s ʞɔןoqʇ∀ ǝʃlooʍ ʍollǝ⅄");
        add(ABRCSlabs.SLAB_WOOL_LIME.get(), "qɐ⅃s ʞɔןoqʇ∀ ǝʃlooʍ ǝɯᴉ⅃");
        add(ABRCSlabs.SLAB_WOOL_PINK.get(), "qɐ⅃s ʞɔןoqʇ∀ ǝʃlooʍ ʞuᴉԀ");
        add(ABRCSlabs.SLAB_WOOL_GRAY.get(), "qɐ⅃s ʞɔןoqʇ∀ ǝʃlooʍ ʎɐɹƃ");
        add(ABRCSlabs.SLAB_WOOL_LIGHT_GRAY.get(), "qɐ⅃s ʞɔןoqʇ∀ ǝʃlooʍ ʎɐɹƃ ʇɥƃᴉ⅃");
        add(ABRCSlabs.SLAB_WOOL_CYAN.get(), "qɐ⅃s ʞɔןoqʇ∀ ǝʃlooʍ uɐ⅄ɔ");
        add(ABRCSlabs.SLAB_WOOL_PURPLE.get(), "qɐ⅃s ʞɔןoqʇ∀ ǝʃlooʍ ǝןԀɹn⅄");
        add(ABRCSlabs.SLAB_WOOL_BLUE.get(), "qɐ⅃s ʞɔןoqʇ∀ ǝʃlooʍ ǝǝןq");
        add(ABRCSlabs.SLAB_WOOL_BROWN.get(), "qɐ⅃s ʞɔןoqʇ∀ ǝʃlooʍ uʍɹo⅃");
        add(ABRCSlabs.SLAB_WOOL_GREEN.get(), "qɐ⅃s ʞɔןoqʇ∀ ǝʃlooʍ uǝǝɹƃ");
        add(ABRCSlabs.SLAB_WOOL_RED.get(), "qɐ⅃s ʞɔןoqʇ∀ ǝʃlooʍ pǝɹ");


        //Starirs
        add(ABRCStairs.STAIR_BRIGHT_WHITE.get(), "sɹᴉɐɹʇS ʞɔןoqʇ∀ ʇɔןᴉq∀ ǝʇɥM ʇɥƃᴉɹꞁ");
        add(ABRCStairs.STAIR_BRIGHT_BLACK.get(), "sɹᴉɐɹʇS ʞɔןoqʇ∀ ʇɔןᴉq∀ ʞɔɐןq ʇɥƃᴉɹꞁ");
        add(ABRCStairs.STAIR_BRIGHT_ORANGE.get(), "sɹᴉɐɹʇS ʞɔןoqʇ∀ ʇɔןᴉq∀ ǝƃuɐɹO ʇɥƃᴉɹꞁ");
        add(ABRCStairs.STAIR_BRIGHT_MAGENTA.get(), "sɹᴉɐɹʇS ʞɔןoqʇ∀ ʇɔןᴉq∀ ɐʇuǝƃɐW ʇɥƃᴉɹꞁ");
        add(ABRCStairs.STAIR_BRIGHT_YELLOW.get(), "sɹᴉɐɹʇS ʞɔןoqʇ∀ ʇɔןᴉq∀ ʍollǝ⅄ ʇɥƃᴉɹꞁ");
        add(ABRCStairs.STAIR_BRIGHT_CYAN.get(), "sɹᴉɐɹʇS ʞɔןoqʇ∀ ʇɔןᴉq∀ uɐ⅄ɔ ʇɥƃᴉɹꞁ");
        add(ABRCStairs.STAIR_BRIGHT_BLUE.get(), "sɹᴉɐɹʇS ʞɔןoqʇ∀ ʇɔןᴉq∀ ǝǝןq ʇɥƃᴉɹꞁ");
        add(ABRCStairs.STAIR_BRIGHT_GREEN.get(), "sɹᴉɐɹʇS ʞɔןoqʇ∀ ʇɔןᴉq∀ uǝǝɹƃ ʇɥƃᴉɹꞁ");
        add(ABRCStairs.STAIR_BRIGHT_RED.get(), "sɹᴉɐɹʇS ʞɔןoqʇ∀ ʇɔןᴉq∀ pǝɹ ʇɥƃᴉɹꞁ");

        add(ABRCStairs.STAIR_WOOL_WHITE.get(), "sɹᴉɐɹʇS ʞɔןoqʇ∀ ʇɔןᴉq∀ ǝʃlooʍ ǝʇɥM");
        add(ABRCStairs.STAIR_WOOL_ORANGE.get(), "sɹᴉɐɹʇS ʞɔןoqʇ∀ ʇɔןᴉq∀ ǝʃlooʍ ǝƃuɐɹO");
        add(ABRCStairs.STAIR_WOOL_MAGENTA.get(), "sɹᴉɐɹʇS ʞɔןoqʇ∀ ʇɔןᴉq∀ ǝʃlooʍ ɐʇuǝƃɐW");
        add(ABRCStairs.STAIR_WOOL_LIGHT_BLUE.get(), "sɹᴉɐɹʇS ʞɔןoqʇ∀ ʇɔןᴉq∀ ǝʃlooʍ ǝǝןq ʇɥƃᴉ⅃");
        add(ABRCStairs.STAIR_WOOL_YELLOW.get(), "sɹᴉɐɹʇS ʞɔןoqʇ∀ ʇɔןᴉq∀ ǝʃlooʍ ʍollǝ⅄");
        add(ABRCStairs.STAIR_WOOL_LIME.get(), "sɹᴉɐɹʇS ʞɔןoqʇ∀ ʇɔןᴉq∀ ǝʃlooʍ ǝɯᴉ⅃");
        add(ABRCStairs.STAIR_WOOL_PINK.get(), "sɹᴉɐɹʇS ʞɔןoqʇ∀ ʇɔןᴉq∀ ǝʃlooʍ ʞuᴉԀ");
        add(ABRCStairs.STAIR_WOOL_GRAY.get(), "sɹᴉɐɹʇS ʞɔןoqʇ∀ ʇɔןᴉq∀ ǝʃlooʍ ʎɐɹƃ");
        add(ABRCStairs.STAIR_WOOL_LIGHT_GRAY.get(), "sɹᴉɐɹʇS ʞɔןoqʇ∀ ʇɔןᴉq∀ ǝʃlooʍ ʎɐɹƃ ʇɥƃᴉ⅃");
        add(ABRCStairs.STAIR_WOOL_CYAN.get(), "sɹᴉɐɹʇS ʞɔןoqʇ∀ ʇɔןᴉq∀ ǝʃlooʍ uɐ⅄ɔ");
        add(ABRCStairs.STAIR_WOOL_PURPLE.get(), "sɹᴉɐɹʇS ʞɔןoqʇ∀ ʇɔןᴉq∀ ǝʃlooʍ ǝןԀɹn⅄");
        add(ABRCStairs.STAIR_WOOL_BLUE.get(), "sɹᴉɐɹʇS ʞɔןoqʇ∀ ʇɔןᴉq∀ ǝʃlooʍ ǝǝןq");
        add(ABRCStairs.STAIR_WOOL_BROWN.get(), "sɹᴉɐɹʇS ʞɔןoqʇ∀ ʇɔןᴉq∀ ǝʃlooʍ uʍɹo⅃");
        add(ABRCStairs.STAIR_WOOL_GREEN.get(), "sɹᴉɐɹʇS ʞɔןoqʇ∀ ʇɔןᴉq∀ ǝʃlooʍ uǝǝɹƃ");
        add(ABRCStairs.STAIR_WOOL_RED.get(), "sɹᴉɐɹʇS ʞɔןoqʇ∀ ʇɔןᴉq∀ ǝʃlooʍ pǝɹ");
