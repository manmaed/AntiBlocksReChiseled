...
public class ABRClolus extends LanguageProvider {
 ...
 protected void addTranslations() {
  ...
  //SLABS
  add(ABRCSlabs.SLAB_BRIGHT_WHITE.get(), "Britee Whytez Antibawk Clawwed Half Bloc");
  add(ABRCSlabs.SLAB_BRIGHT_BLACK.get(), "Britee Blakkz Antibawk Clawwed Half Bloc");
  add(ABRCSlabs.SLAB_BRIGHT_ORANGE.get(), "Britee Oranjz Antibawk Clawwed Half Bloc");
  add(ABRCSlabs.SLAB_BRIGHT_MAGENTA.get(), "Britee Magentz Antibawk Clawwed Half Bloc");
  add(ABRCSlabs.SLAB_BRIGHT_YELLOW.get(), "Britee Yellerz Antibawk Clawwed Half Bloc");
  add(ABRCSlabs.SLAB_BRIGHT_CYAN.get(), "Britee Syanz Antibawk Clawwed Half Bloc");
  add(ABRCSlabs.SLAB_BRIGHT_BLUE.get(), "Britee Bluuz Antibawk Clawwed Half Bloc");
  add(ABRCSlabs.SLAB_BRIGHT_GREEN.get(), "Britee Greenz Antibawk Clawwed Half Bloc");
  add(ABRCSlabs.SLAB_BRIGHT_RED.get(), "Britee Reddz Antibawk Clawwed Half Bloc");

  add(ABRCSlabs.SLAB_WOOL_WHITE.get(), "Floof Whyte Antibawk Clawwed Half Bloc");
  add(ABRCSlabs.SLAB_WOOL_ORANGE.get(), "Floof Oranjz Antibawk Clawwed Half Bloc");
  add(ABRCSlabs.SLAB_WOOL_MAGENTA.get(), "Floof Magentz Antibawk Clawwed Half Bloc");
  add(ABRCSlabs.SLAB_WOOL_LIGHT_BLUE.get(), "Floof Lite Bluuz Antibawk Clawwed Half Bloc");
  add(ABRCSlabs.SLAB_WOOL_YELLOW.get(), "Floof Yellerz Antibawk Clawwed Half Bloc");
  add(ABRCSlabs.SLAB_WOOL_LIME.get(), "Floof Laim Antibawk Clawwed Half Bloc");
  add(ABRCSlabs.SLAB_WOOL_PINK.get(), "Floof Pinkz Antibawk Clawwed Half Bloc");
  add(ABRCSlabs.SLAB_WOOL_GRAY.get(), "Floof Gray Antibawk Clawwed Half Bloc");
  add(ABRCSlabs.SLAB_WOOL_LIGHT_GRAY.get(), "Floof Lite Gray Antibawk Clawwed Half Bloc");
  add(ABRCSlabs.SLAB_WOOL_CYAN.get(), "Floof Syanz Antibawk Clawwed Half Bloc");
  add(ABRCSlabs.SLAB_WOOL_PURPLE.get(), "Floof Purplz Antibawk Clawwed Half Bloc");
  add(ABRCSlabs.SLAB_WOOL_BLUE.get(), "Floof Bluuz Antibawk Clawwed Half Bloc");
  add(ABRCSlabs.SLAB_WOOL_BROWN.get(), "Floof Brownz Antibawk Clawwed Half Bloc");
  add(ABRCSlabs.SLAB_WOOL_GREEN.get(), "Floof Greenz Antibawk Clawwed Half Bloc");
  add(ABRCSlabs.SLAB_WOOL_RED.get(), "Floof Reddz Antibawk Clawwed Half Bloc");

  //Starirs
  add(ABRCStairs.STAIR_BRIGHT_WHITE.get(), "Britee Whytez Antibawk Stepz");
  add(ABRCStairs.STAIR_BRIGHT_BLACK.get(), "Britee Blakkz Antibawk Stepz");
  add(ABRCStairs.STAIR_BRIGHT_ORANGE.get(), "Britee Oranjz Antibawk Stepz");
  add(ABRCStairs.STAIR_BRIGHT_MAGENTA.get(), "Britee Magentz Antibawk Stepz");
  add(ABRCStairs.STAIR_BRIGHT_YELLOW.get(), "Britee Yellerz Antibawk Stepz");
  add(ABRCStairs.STAIR_BRIGHT_CYAN.get(), "Britee Syanz Antibawk Stepz");
  add(ABRCStairs.STAIR_BRIGHT_BLUE.get(), "Britee Bluuz Antibawk Stepz");
  add(ABRCStairs.STAIR_BRIGHT_GREEN.get(), "Britee Greenz Antibawk Stepz");
  add(ABRCStairs.STAIR_BRIGHT_RED.get(), "Britee Reddz Antibawk Stepz");

  add(ABRCStairs.STAIR_WOOL_WHITE.get(), "Floof Whyte Antibawk Stepz");
  add(ABRCStairs.STAIR_WOOL_ORANGE.get(), "Floof Oranjz Antibawk Stepz");
  add(ABRCStairs.STAIR_WOOL_MAGENTA.get(), "Floof Magentz Antibawk Stepz");
  add(ABRCStairs.STAIR_WOOL_LIGHT_BLUE.get(), "Floof Lite Bluuz Antibawk Stepz");
  add(ABRCStairs.STAIR_WOOL_YELLOW.get(), "Floof Yellerz Antibawk Stepz");
  add(ABRCStairs.STAIR_WOOL_LIME.get(), "Floof Laim Antibawk Stepz");
  add(ABRCStairs.STAIR_WOOL_PINK.get(), "Floof Pinkz Antibawk Stepz");
  add(ABRCStairs.STAIR_WOOL_GRAY.get(), "Floof Gray Antibawk Stepz");
  add(ABRCStairs.STAIR_WOOL_LIGHT_GRAY.get(), "Floof Lite Gray Antibawk Stepz");
  add(ABRCStairs.STAIR_WOOL_CYAN.get(), "Floof Syanz Antibawk Stepz");
  add(ABRCStairs.STAIR_WOOL_PURPLE.get(), "Floof Purplz Antibawk Stepz");
  add(ABRCStairs.STAIR_WOOL_BLUE.get(), "Floof Bluuz Antibawk Stepz");
  add(ABRCStairs.STAIR_WOOL_BROWN.get(), "Floof Brownz Antibawk Stepz");
  add(ABRCStairs.STAIR_WOOL_GREEN.get(), "Floof Greenz Antibawk Stepz");
  add(ABRCStairs.STAIR_WOOL_RED.get(), "Floof Reddz Antibawk Stepz");
