...
// Slabs
        add(ABRCSlabs.SLAB_BRIGHT_WHITE.get().asItem(), "joqwI' mach chIS wov botHa'");
        add(ABRCSlabs.SLAB_BRIGHT_BLACK.get().asItem(), "joqwI' mach qIj wov botHa'");
        add(ABRCSlabs.SLAB_BRIGHT_ORANGE.get().asItem(), "joqwI' mach Doq SuD wov botHa'");
        add(ABRCSlabs.SLAB_BRIGHT_MAGENTA.get().asItem(), "joqwI' mach Doq SuD qub wov botHa'");
        add(ABRCSlabs.SLAB_BRIGHT_YELLOW.get().asItem(), "joqwI' mach SuD wov botHa'");
        add(ABRCSlabs.SLAB_BRIGHT_CYAN.get().asItem(), "joqwI' mach SuD watlh wov botHa'");
        add(ABRCSlabs.SLAB_BRIGHT_BLUE.get().asItem(), "joqwI' mach SuD qargh wov botHa'");
        add(ABRCSlabs.SLAB_BRIGHT_GREEN.get().asItem(), "joqwI' mach SuD wov botHa'");
        add(ABRCSlabs.SLAB_BRIGHT_RED.get().asItem(), "joqwI' mach Doq wov botHa'");

        add(ABRCSlabs.SLAB_WOOL_WHITE.get().asItem(), "joqwI' mach voDngogh chIS botHa'");
        add(ABRCSlabs.SLAB_WOOL_ORANGE.get().asItem(), "joqwI' mach voDngogh Doq SuD botHa'");
        add(ABRCSlabs.SLAB_WOOL_MAGENTA.get().asItem(), "joqwI' mach voDngogh Doq SuD qub botHa'");
        add(ABRCSlabs.SLAB_WOOL_LIGHT_BLUE.get().asItem(), "joqwI' mach voDngogh SuD wov qargh botHa'");
        add(ABRCSlabs.SLAB_WOOL_YELLOW.get().asItem(), "joqwI' mach voDngogh SuD botHa'");
        add(ABRCSlabs.SLAB_WOOL_LIME.get().asItem(), "joqwI' mach voDngogh SuD wovqu' botHa'");
        add(ABRCSlabs.SLAB_WOOL_PINK.get().asItem(), "joqwI' mach voDngogh Doq wov botHa'");
        add(ABRCSlabs.SLAB_WOOL_GRAY.get().asItem(), "joqwI' mach voDngogh qIj wov botHa'");
        add(ABRCSlabs.SLAB_WOOL_LIGHT_GRAY.get().asItem(), "joqwI' mach voDngogh qIj wovqu' botHa'");
        add(ABRCSlabs.SLAB_WOOL_CYAN.get().asItem(), "joqwI' mach voDngogh SuD watlh botHa'");
        add(ABRCSlabs.SLAB_WOOL_PURPLE.get().asItem(), "joqwI' mach voDngogh Doq SuD qub botHa'");
        add(ABRCSlabs.SLAB_WOOL_BLUE.get().asItem(), "joqwI' mach voDngogh SuD qargh botHa'");
        add(ABRCSlabs.SLAB_WOOL_BROWN.get().asItem(), "joqwI' mach voDngogh Doq Hurgh botHa'");
        add(ABRCSlabs.SLAB_WOOL_GREEN.get().asItem(), "joqwI' mach voDngogh SuD botHa'");
        add(ABRCSlabs.SLAB_WOOL_RED.get().asItem(), "joqwI' mach voDngogh Doq botHa'");

// Stairs
        add(ABRCStairs.STAIR_BRIGHT_WHITE.get().asItem(), "letlh chIS wov botHa'");
        add(ABRCStairs.STAIR_BRIGHT_BLACK.get().asItem(), "letlh qIj wov botHa'");
        add(ABRCStairs.STAIR_BRIGHT_ORANGE.get().asItem(), "letlh Doq SuD wov botHa'");
        add(ABRCStairs.STAIR_BRIGHT_MAGENTA.get().asItem(), "letlh Doq SuD qub wov botHa'");
        add(ABRCStairs.STAIR_BRIGHT_YELLOW.get().asItem(), "letlh SuD wov botHa'");
        add(ABRCStairs.STAIR_BRIGHT_CYAN.get().asItem(), "letlh SuD watlh wov botHa'");
        add(ABRCStairs.STAIR_BRIGHT_BLUE.get().asItem(), "letlh SuD qargh wov botHa'");
        add(ABRCStairs.STAIR_BRIGHT_GREEN.get().asItem(), "letlh SuD wov botHa'");
        add(ABRCStairs.STAIR_BRIGHT_RED.get().asItem(), "letlh Doq wov botHa'");

        add(ABRCStairs.STAIR_WOOL_WHITE.get().asItem(), "letlh voDngogh chIS botHa'");
        add(ABRCStairs.STAIR_WOOL_ORANGE.get().asItem(), "letlh voDngogh Doq SuD botHa'");
        add(ABRCStairs.STAIR_WOOL_MAGENTA.get().asItem(), "letlh voDngogh Doq SuD qub botHa'");
        add(ABRCStairs.STAIR_WOOL_LIGHT_BLUE.get().asItem(), "letlh voDngogh SuD wov qargh botHa'");
        add(ABRCStairs.STAIR_WOOL_YELLOW.get().asItem(), "letlh voDngogh SuD botHa'");
        add(ABRCStairs.STAIR_WOOL_LIME.get().asItem(), "letlh voDngogh SuD wovqu' botHa'");
        add(ABRCStairs.STAIR_WOOL_PINK.get().asItem(), "letlh voDngogh Doq wov botHa'");
        add(ABRCStairs.STAIR_WOOL_GRAY.get().asItem(), "letlh voDngogh qIj wov botHa'");
        add(ABRCStairs.STAIR_WOOL_LIGHT_GRAY.get().asItem(), "letlh voDngogh qIj wovqu' botHa'");
        add(ABRCStairs.STAIR_WOOL_CYAN.get().asItem(), "letlh voDngogh SuD watlh botHa'");
        add(ABRCStairs.STAIR_WOOL_PURPLE.get().asItem(), "letlh voDngogh Doq SuD qub botHa'");
        add(ABRCStairs.STAIR_WOOL_BLUE.get().asItem(), "letlh voDngogh SuD qargh botHa'");
        add(ABRCStairs.STAIR_WOOL_BROWN.get().asItem(), "letlh voDngogh Doq Hurgh botHa'");
        add(ABRCStairs.STAIR_WOOL_GREEN.get().asItem(), "letlh voDngogh SuD botHa'");
        add(ABRCStairs.STAIR_WOOL_RED.get().asItem(), "letlh voDngogh Doq botHa'");
